...
impl EncodedOwnerSecret {
    ...
    pub fn take_secret_blinding(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.secret_blinding, ::std::string::String::new())
    }
}
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.secret_blinding)?;
                },
                _ => {
...
impl ::protobuf::Message for EncodedConfidentialCredit {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_proto3_string_into(wire_type, is, &mut self.point)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x05point\"Q\n\tVclResult\x12\x16\n\x06credit\x18\x01\x20\x01(\tR\x06cre\
    dit\x12\x16\n\x06secret\x18\x02\x20\x01(\tR\x06secret\x12\x14\n\x05proof\
    \x18\x03\x20\x01(\tR\x05proofB\x1e\n\x1acom.webank.wedpr.vcl.protoP\x01b\
    \x06proto3\
";
