...
pub struct BatchProof {
    // message fields
    pub c1_credit: ::protobuf::RepeatedField<::std::string::String>,
    pub c2_credit: ::protobuf::RepeatedField<::std::string::String>,
    pub c3_credit: ::protobuf::RepeatedField<::std::string::String>,
    pub proof: ::protobuf::RepeatedField<::std::string::String>,
    // special fields
    pub unknown_fields: ::protobuf::UnknownFields,
    pub cached_size: ::protobuf::CachedSize,
}
...
impl BatchProof {
    ...
    // repeated string c1_credit = 1;


    pub fn get_c1_credit(&self) -> &[::std::string::String] {
        &self.c1_credit
    }
    ...
    // Param is passed by value, moved
    pub fn set_c1_credit(&mut self, v: ::protobuf::RepeatedField<::std::string::String>) {
        self.c1_credit = v;
    }

    // Mutable pointer to the field.
    pub fn mut_c1_credit(&mut self) -> &mut ::protobuf::RepeatedField<::std::string::String> {
        &mut self.c1_credit
    }

    // Take field
    pub fn take_c1_credit(&mut self) -> ::protobuf::RepeatedField<::std::string::String> {
        ::std::mem::replace(&mut self.c1_credit, ::protobuf::RepeatedField::new())
    }

    // repeated string c2_credit = 2;


    pub fn get_c2_credit(&self) -> &[::std::string::String] {
        &self.c2_credit
    }
    ...
    // Param is passed by value, moved
    pub fn set_c2_credit(&mut self, v: ::protobuf::RepeatedField<::std::string::String>) {
        self.c2_credit = v;
    }

    // Mutable pointer to the field.
    pub fn mut_c2_credit(&mut self) -> &mut ::protobuf::RepeatedField<::std::string::String> {
        &mut self.c2_credit
    }

    // Take field
    pub fn take_c2_credit(&mut self) -> ::protobuf::RepeatedField<::std::string::String> {
        ::std::mem::replace(&mut self.c2_credit, ::protobuf::RepeatedField::new())
    }

    // repeated string c3_credit = 3;


    pub fn get_c3_credit(&self) -> &[::std::string::String] {
        &self.c3_credit
    }
    ...
    // Param is passed by value, moved
    pub fn set_c3_credit(&mut self, v: ::protobuf::RepeatedField<::std::string::String>) {
        self.c3_credit = v;
    }

    // Mutable pointer to the field.
    pub fn mut_c3_credit(&mut self) -> &mut ::protobuf::RepeatedField<::std::string::String> {
        &mut self.c3_credit
    }

    // Take field
    pub fn take_c3_credit(&mut self) -> ::protobuf::RepeatedField<::std::string::String> {
        ::std::mem::replace(&mut self.c3_credit, ::protobuf::RepeatedField::new())
    }

    // repeated string proof = 4;


    pub fn get_proof(&self) -> &[::std::string::String] {
        &self.proof
    }
    pub fn clear_proof(&mut self) {
        self.proof.clear();
    ...
    // Param is passed by value, moved
    pub fn set_proof(&mut self, v: ::protobuf::RepeatedField<::std::string::String>) {
        self.proof = v;
    }

    // Mutable pointer to the field.
    pub fn mut_proof(&mut self) -> &mut ::protobuf::RepeatedField<::std::string::String> {
        &mut self.proof
    }

    // Take field
    pub fn take_proof(&mut self) -> ::protobuf::RepeatedField<::std::string::String> {
...
impl ::protobuf::Message for BatchProof {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_repeated_string_into(wire_type, is, &mut self.c1_credit)?;
                },
                2 => {
                    ::protobuf::rt::read_repeated_string_into(wire_type, is, &mut self.c2_credit)?;
                },
                3 => {
                    ::protobuf::rt::read_repeated_string_into(wire_type, is, &mut self.c3_credit)?;
                },
                4 => {
                    ::protobuf::rt::read_repeated_string_into(wire_type, is, &mut self.proof)?;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in &self.c1_credit {
            my_size += ::protobuf::rt::string_size(1, &value);
        };
        for value in &self.c2_credit {
            my_size += ::protobuf::rt::string_size(2, &value);
        };
        for value in &self.c3_credit {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        for v in &self.c1_credit {
            os.write_string(1, &v)?;
        };
        for v in &self.c2_credit {
            os.write_string(2, &v)?;
        };
        for v in &self.c3_credit {
            os.write_string(3, &v)?;
        };
        for v in &self.proof {
            os.write_string(4, &v)?;
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "c1_credit",
                |m: &BatchProof| { &m.c1_credit },
                |m: &mut BatchProof| { &mut m.c1_credit },
            ));
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "c2_credit",
                |m: &BatchProof| { &m.c2_credit },
                |m: &mut BatchProof| { &mut m.c2_credit },
            ));
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "c3_credit",
                |m: &BatchProof| { &m.c3_credit },
                |m: &mut BatchProof| { &mut m.c3_credit },
            ));
            fields.push(::protobuf::reflect::accessor::make_repeated_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "proof",
                |m: &BatchProof| { &m.proof },
                |m: &mut BatchProof| { &mut m.proof },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x05proof\x18\x03\x20\x01(\tR\x05proof\"y\n\nBatchProof\x12\x1b\n\tc1_cr\
    edit\x18\x01\x20\x03(\tR\x08c1Credit\x12\x1b\n\tc2_credit\x18\x02\x20\
    \x03(\tR\x08c2Credit\x12\x1b\n\tc3_credit\x18\x03\x20\x03(\tR\x08c3Credi\
    t\x12\x14\n\x05proof\x18\x04\x20\x03(\tR\x05proofB\x1e\n\x1acom.webank.w\
    edpr.vcl.protoP\x01b\x06proto3\
";
