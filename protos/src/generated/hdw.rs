...
//! Generated file from `solution/hdw/hdw.proto`
...
impl<'a> ::std::default::Default for &'a HdwResult {
    fn default() -> &'a HdwResult {
        <HdwResult as ::protobuf::Message>::default_instance()
    }
}

impl HdwResult {
    pub fn new() -> HdwResult {
    ...
    pub fn get_master_key(&self) -> &str {
        &self.master_key
    }
    ...
    // Param is passed by value, moved
    pub fn set_master_key(&mut self, v: ::std::string::String) {
        self.master_key = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_master_key(&mut self) -> &mut ::std::string::String {
        &mut self.master_key
    }

    // Take field
    pub fn take_master_key(&mut self) -> ::std::string::String {
        ::std::mem::replace(&mut self.master_key, ::std::string::String::new())
    }

    // .com.webank.wedpr.scd.proto.ExtendedKeyPair key_pair = 3;

    pub fn get_key_pair(&self) -> &ExtendedKeyPair {
        self.key_pair.as_ref().unwrap_or_else(|| {
    ...
    pub fn take_key_pair(&mut self) -> ExtendedKeyPair {
        self.key_pair
            .take()
            .unwrap_or_else(|| ExtendedKeyPair::new())
    }
}

impl ::protobuf::Message for HdwResult {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.master_key.is_empty() {
            my_size += ::protobuf::rt::string_size(2, &self.master_key);
        }
    ...
    ) -> ::protobuf::ProtobufResult<()>
    {
        ...
        if !self.master_key.is_empty() {
            os.write_string(2, &self.master_key)?;
        }
        if let Some(ref v) = self.key_pair.as_ref() {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "mnemonic",
                |m: &HdwResult| { &m.mnemonic },
                |m: &mut HdwResult| { &mut m.mnemonic },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeString>(
                "master_key",
                |m: &HdwResult| { &m.master_key },
                |m: &mut HdwResult| { &mut m.master_key },
            ));
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<ExtendedKeyPair>>(
                "key_pair",
                |m: &HdwResult| { &m.key_pair },
                |m: &mut HdwResult| { &mut m.key_pair },
            ));
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<HdwResult>(
                "HdwResult",
                fields,
    ...
    fn default_instance() -> &'static HdwResult {
        static instance: ::protobuf::rt::LazyV2<HdwResult> =
            ::protobuf::rt::LazyV2::INIT;
        instance.get(HdwResult::new)
    }
}

impl ::protobuf::Clear for HdwResult {
    fn clear(&mut self) {
        self.mnemonic.clear();
        self.master_key.clear();
        self.key_pair.clear();
...
impl ::std::fmt::Debug for HdwResult {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        ::protobuf::text_format::fmt(self, f)
    }
}

impl ::protobuf::reflect::ProtobufValue for HdwResult {
...
pub struct ExtendedKeyPair {
    // message fields
    pub extended_private_key: ::std::string::String,
...
impl ExtendedKeyPair {
    ...
    // string extended_private_key = 1;

    pub fn get_extended_private_key(&self) -> &str {
    ...
    // Param is passed by value, moved
    pub fn set_extended_private_key(&mut self, v: ::std::string::String) {
        self.extended_private_key = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_extended_private_key(&mut self) -> &mut ::std::string::String {
        &mut self.extended_private_key
    }

    // Take field
    pub fn take_extended_private_key(&mut self) -> ::std::string::String {
        ::std::mem::replace(
            &mut self.extended_private_key,
    ...
    pub fn get_extended_public_key(&self) -> &str {
    ...
    // Param is passed by value, moved
    pub fn set_extended_public_key(&mut self, v: ::std::string::String) {
        self.extended_public_key = v;
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_extended_public_key(&mut self) -> &mut ::std::string::String {
        &mut self.extended_public_key
    }

    // Take field
    pub fn take_extended_public_key(&mut self) -> ::std::string::String {
        ::std::mem::replace(
            &mut self.extended_public_key,
            ::std::string::String::new(),
        )
...
impl ::protobuf::Message for ExtendedKeyPair {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.extended_private_key.is_empty() {
            my_size +=
                ::protobuf::rt::string_size(1, &self.extended_private_key);
        }
        if !self.extended_public_key.is_empty() {
            my_size +=
                ::protobuf::rt::string_size(2, &self.extended_public_key);
        }
        my_size +=
            ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
    ...
    {
        if !self.extended_private_key.is_empty() {
            os.write_string(1, &self.extended_private_key)?;
        }
        if !self.extended_public_key.is_empty() {
            os.write_string(2, &self.extended_public_key)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn default_instance() -> &'static ExtendedKeyPair {
        static instance: ::protobuf::rt::LazyV2<ExtendedKeyPair> =
            ::protobuf::rt::LazyV2::INIT;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16solution/hdw/hdw.proto\x12\x1acom.webank.wedpr.scd.proto\"\x8e\x01\
    \n\tHdwResult\x12\x1a\n\x08mnemonic\x18\x01\x20\x01(\tR\x08mnemonic\x12\
    \x1d\n\nmaster_key\x18\x02\x20\x01(\tR\tmasterKey\x12F\n\x08key_pair\x18\
    \x03\x20\x01(\x0b2+.com.webank.wedpr.scd.proto.ExtendedKeyPairR\x07keyPa\
    ir\"s\n\x0fExtendedKeyPair\x120\n\x14extended_private_key\x18\x01\x20\
    \x01(\tR\x12extendedPrivateKey\x12.\n\x13extended_public_key\x18\x02\x20\
    \x01(\tR\x11extendedPublicKeyB\x1e\n\x1acom.webank.wedpr.hdw.protoP\x01b\
    \x06proto3\
";
