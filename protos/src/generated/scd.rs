    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<
                CertificateSchema,
            >("CertificateSchema", fields, file_descriptor_proto())
        })
    }

    fn default_instance() -> &'static CertificateSchema {
        static instance: ::protobuf::rt::LazyV2<CertificateSchema> =
            ::protobuf::rt::LazyV2::INIT;
...
impl CertificateTemplate {
    ...
    pub fn get_certificate_schema(&self) -> &CertificateSchema {
        self.certificate_schema.as_ref().unwrap_or_else(|| {
            <CertificateSchema as ::protobuf::Message>::default_instance()
        })
    }
    ...
    pub fn take_certificate_schema(&mut self) -> CertificateSchema {
        self.certificate_schema
            .take()
            .unwrap_or_else(|| CertificateSchema::new())
    }
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_template_correctness_proof(
        &mut self,
    ...
    pub fn get_template_public_key(&self) -> &TemplatePublicKey {
        self.template_public_key.as_ref().unwrap_or_else(|| {
...
impl ::protobuf::Message for CertificateTemplate {
    ...
    fn default_instance() -> &'static CertificateTemplate {
        static instance: ::protobuf::rt::LazyV2<CertificateTemplate> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for TemplatePrivateKey {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<
                TemplatePrivateKey,
            >("TemplatePrivateKey", fields, file_descriptor_proto())
        })
    }

    fn default_instance() -> &'static TemplatePrivateKey {
        static instance: ::protobuf::rt::LazyV2<TemplatePrivateKey> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for AttributeDict {
    ...
    fn default_instance() -> &'static AttributeDict {
        static instance: ::protobuf::rt::LazyV2<AttributeDict> =
            ::protobuf::rt::LazyV2::INIT;
...
impl BlindedCertificateSecret {
    ...
    // Param is passed by value, moved
    pub fn set_blinded_certificate_secrets(
        &mut self,
        v: ::std::string::String,
    )
    {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_blinded_certificate_secrets(
        &mut self,
    ) -> &mut ::std::string::String {
    ...
    // Take field
    pub fn take_blinded_certificate_secrets(
        &mut self,
    ) -> ::std::string::String {
        ::std::mem::replace(
            &mut self.blinded_certificate_secrets,
    ...
    // Param is passed by value, moved
    pub fn set_blinded_certificate_secrets_correctness_proof(
        &mut self,
        v: ::std::string::String,
    )
    {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_blinded_certificate_secrets_correctness_proof(
        &mut self,
    ) -> &mut ::std::string::String {
    ...
    // Take field
    pub fn take_blinded_certificate_secrets_correctness_proof(
        &mut self,
    ) -> ::std::string::String {
        ::std::mem::replace(
            &mut self.blinded_certificate_secrets_correctness_proof,
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ...
                >(
                    ...
                    |m: &BlindedCertificateSecret| {
                        &m.blinded_certificate_secrets
                    },
                    |m: &mut BlindedCertificateSecret| {
                        &mut m.blinded_certificate_secrets
                    },
                ),
            );
            fields.push(
                ...
                >(
                    "blinded_certificate_secrets_correctness_proof",
                    |m: &BlindedCertificateSecret| {
                        &m.blinded_certificate_secrets_correctness_proof
                    },
                    |m: &mut BlindedCertificateSecret| {
                        &mut m.blinded_certificate_secrets_correctness_proof
                    },
                ),
            );
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<
            ...
            >(
                "BlindedCertificateSecret", fields, file_descriptor_proto()
            )
        })
    }

    fn default_instance() -> &'static BlindedCertificateSecret {
        static instance: ::protobuf::rt::LazyV2<BlindedCertificateSecret> =
            ::protobuf::rt::LazyV2::INIT;
...
impl ::protobuf::Message for CertificateSignature {
    ...
    fn compute_size(&self) -> u32 {
        ...
        if !self.certificate_signature.is_empty() {
            my_size +=
                ::protobuf::rt::string_size(1, &self.certificate_signature);
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            >(
                "CertificateSignature", fields, file_descriptor_proto()
            )
        })
    }

    fn default_instance() -> &'static CertificateSignature {
        static instance: ::protobuf::rt::LazyV2<CertificateSignature> =
            ::protobuf::rt::LazyV2::INIT;
...
impl VerificationRuleSet {
    ...
    // Param is passed by value, moved
    pub fn set_revealed_attribute_name(
        &mut self,
        v: ::protobuf::RepeatedField<::std::string::String>,
    )
    {
    ...
    // Mutable pointer to the field.
    pub fn mut_revealed_attribute_name(
        &mut self,
    ) -> &mut ::protobuf::RepeatedField<::std::string::String> {
    ...
    // Take field
    pub fn take_revealed_attribute_name(
        &mut self,
    ) -> ::protobuf::RepeatedField<::std::string::String> {
        ::std::mem::replace(
            &mut self.revealed_attribute_name,
    ...
    // Param is passed by value, moved
    pub fn set_attribute_predicate(
        &mut self,
    ...
    // Mutable pointer to the field.
    pub fn mut_attribute_predicate(
        &mut self,
    ...
    // Take field
    pub fn take_attribute_predicate(
        &mut self,
        ...
        descriptor.get(|| {
            ...
            fields.push(
                ...
                >(
                    ...
                    |m: &mut VerificationRuleSet| {
                        &mut m.revealed_attribute_name
                    },
                ),
            );
            fields.push(
            ...
            ::protobuf::reflect::MessageDescriptor::new_pb_name::<
                VerificationRuleSet,
            >("VerificationRuleSet", fields, file_descriptor_proto())
        })
    }

    fn default_instance() -> &'static VerificationRuleSet {
        static instance: ::protobuf::rt::LazyV2<VerificationRuleSet> =
            ::protobuf::rt::LazyV2::INIT;
...
impl SignCertificateRequest {
    ...
    pub fn get_certificate_attribute_dict(&self) -> &AttributeDict {
        self.certificate_attribute_dict.as_ref().unwrap_or_else(|| {
            <AttributeDict as ::protobuf::Message>::default_instance()
        })
    }
    ...
    pub fn take_certificate_attribute_dict(&mut self) -> AttributeDict {
        self.certificate_attribute_dict
            .take()
            .unwrap_or_else(|| AttributeDict::new())
    }
...
impl ::protobuf::Message for SignCertificateRequest {
            ...
            match field_number {
                1 => {
                    ::protobuf::rt::read_singular_message_into(
                        wire_type,
                        is,
                        &mut self.certificate_attribute_dict,
                    )?;
                },
                2 => {
                    ::protobuf::rt::read_singular_proto3_string_into(
    ...
    fn default_instance() -> &'static SignCertificateRequest {
        static instance: ::protobuf::rt::LazyV2<SignCertificateRequest> =
            ::protobuf::rt::LazyV2::INIT;
...
impl VerifyRequest {
    ...
    pub fn get_certificate_template(&self) -> &CertificateTemplate {
        self.certificate_template.as_ref().unwrap_or_else(|| {
            <CertificateTemplate as ::protobuf::Message>::default_instance()
        })
    }
    ...
    pub fn take_certificate_template(&mut self) -> CertificateTemplate {
        self.certificate_template
            .take()
            .unwrap_or_else(|| CertificateTemplate::new())
    }
...
impl ::protobuf::Message for VerifyRequest {
    ...
    fn default_instance() -> &'static VerifyRequest {
        static instance: ::protobuf::rt::LazyV2<VerifyRequest> =
            ::protobuf::rt::LazyV2::INIT;
...
pub struct ScdResult {
    ...
    pub certificate_signature:
        ::protobuf::SingularPtrField<CertificateSignature>,
    pub user_nonce: ::std::string::String,
    pub sign_certificate_request:
        ::protobuf::SingularPtrField<SignCertificateRequest>,
...
impl ScdResult {
    ...
    pub fn get_template_private_key(&self) -> &TemplatePrivateKey {
        self.template_private_key.as_ref().unwrap_or_else(|| {
            <TemplatePrivateKey as ::protobuf::Message>::default_instance()
        })
    }
    ...
    pub fn take_template_private_key(&mut self) -> TemplatePrivateKey {
        self.template_private_key
            .take()
            .unwrap_or_else(|| TemplatePrivateKey::new())
    }
    ...
    // .com.webank.wedpr.scd.proto.CertificateSignature certificate_signature =
    // 4;

    pub fn get_certificate_signature(&self) -> &CertificateSignature {
        self.certificate_signature.as_ref().unwrap_or_else(|| {
            <CertificateSignature as ::protobuf::Message>::default_instance()
        })
    }
    pub fn clear_certificate_signature(&mut self) {
    ...
    pub fn take_certificate_signature(&mut self) -> CertificateSignature {
        self.certificate_signature
            .take()
            .unwrap_or_else(|| CertificateSignature::new())
    }
    ...
    // sign_certificate_request = 6;

    pub fn get_sign_certificate_request(&self) -> &SignCertificateRequest {
        self.sign_certificate_request.as_ref().unwrap_or_else(|| {
            <SignCertificateRequest as ::protobuf::Message>::default_instance()
        })
    }
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_sign_certificate_request(
        &mut self,
    ) -> &mut SignCertificateRequest {
    ...
    pub fn take_sign_certificate_request(&mut self) -> SignCertificateRequest {
        self.sign_certificate_request
            .take()
            .unwrap_or_else(|| SignCertificateRequest::new())
    }
    ...
    // Param is passed by value, moved
    pub fn set_certificate_secrets_blinding_factors(
        &mut self,
        v: ::std::string::String,
    )
    {
    ...
    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_certificate_secrets_blinding_factors(
        &mut self,
    ) -> &mut ::std::string::String {
    ...
    // Take field
    pub fn take_certificate_secrets_blinding_factors(
        &mut self,
    ) -> ::std::string::String {
        ::std::mem::replace(
            &mut self.certificate_secrets_blinding_factors,
    ...
    pub fn get_verify_request(&self) -> &VerifyRequest {
        self.verify_request.as_ref().unwrap_or_else(|| {
            <VerifyRequest as ::protobuf::Message>::default_instance()
        })
    }
...
impl ::protobuf::Message for ScdResult {
            ...
            match field_number {
                ...
                6 => {
                    ::protobuf::rt::read_singular_message_into(
                        wire_type,
                        is,
                        &mut self.sign_certificate_request,
                    )?;
                },
                7 => {
                    ::protobuf::rt::read_singular_proto3_string_into(
                ...
                11 => {
                    ::protobuf::rt::read_singular_message_into(
                        wire_type,
                        is,
                        &mut self.revealed_attribute_dict,
                    )?;
                },
                12 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
    ...
    fn default_instance() -> &'static ScdResult {
        static instance: ::protobuf::rt::LazyV2<ScdResult> =
            ::protobuf::rt::LazyV2::INIT;
