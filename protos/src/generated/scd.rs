...
impl ScdResult {
    ...
    // .com.webank.wedpr.scd.proto.VerifyRequest verify_request = 9;
    ...
    // .com.webank.wedpr.scd.proto.AttributeDict revealed_attribute_dict = 10;
...
impl ::protobuf::Message for ScdResult {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.bool_result != false {
            os.write_bool(11, self.bool_result)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12verification_nonce\x18\x03\x20\x01(\tR\x11verificationNonce\"\xb9\
    ...
    BlindingFactors\x12P\n\x0everify_request\x18\t\x20\x01(\x0b2).com.webank\
    .wedpr.scd.proto.VerifyRequestR\rverifyRequest\x12a\n\x17revealed_attrib\
    ute_dict\x18\n\x20\x01(\x0b2).com.webank.wedpr.scd.proto.AttributeDictR\
    \x15revealedAttributeDict\x12\x1f\n\x0bbool_result\x18\x0b\x20\x01(\x08R\
