        ...
        try {
            ...
            if (osName.contains("windows")) {
                ...
                if (hasLibsslVersion(LIBSSL_1_0)) {
                    WEDPR_SELECTIVE_DISCLOSURE_LIB_PATH =
                            "/WeDPR_dynamic_lib/libffi_selective_disclosure_libssl_1.0.so";
